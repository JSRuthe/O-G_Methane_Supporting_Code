...
%% Table
    ...
    Table(1,1) = size(Plunger.mat1,1);
    Table(2,1) = size(Plunger.mat2,1);
    Table(3,1) = size(NoPlunger.mat3,1);
    Table(4,1) = size(NoPlunger.mat4,1);
    Table(5,1) = size(NoPlunger.mat5,1);
    Table(6,1) = size(NoPlunger.mat6,1); 
    
    Table(1,2) = mean(Plunger.mat1);
    Table(2,2) = mean(Plunger.mat2);
    Table(3,2) = mean(NoPlunger.mat3);
    Table(4,2) = mean(NoPlunger.mat4);
    Table(5,2) = mean(NoPlunger.mat5);
    Table(6,2) = mean(NoPlunger.mat6);

    Table(1,3) = Plunger.events1;
    Table(2,3) = Plunger.events2;
    Table(3,3) = NoPlunger.events3;
    Table(4,3) = NoPlunger.events4;
    Table(5,3) = NoPlunger.events5;
    Table(6,3) = NoPlunger.events6;
